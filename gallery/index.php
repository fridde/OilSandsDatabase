	...
	*/
	...
	function sfpg_javascript()
	{
		...
		function showMenu()
		{
			...
			echo "menu += '<span onmouseover=\"this.className=\'sfpg_button_hover\';\" onmouseout=\"this.className=\'sfpg_button\';\" class=\"sfpg_button\" onclick=\"window.location=\'http://sye.dk/sfpg/\'\"></span>';
